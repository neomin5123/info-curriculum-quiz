const CACHE_NAME = "curriloop-v6-8-0-20260915";
...
const CORE_PRECACHE = [
  "/index.html",
  "/styles.css?v=6.8.0",
  "/data/curriculum-data.js?v=6.8.0",
  "/data/supplemental-data.js?v=6.8.0",
  "/js/learning-engine.js?v=6.8.0",
  "/js/practical-engine.js?v=6.8.0",
  "/js/grading-engine.js?v=6.8.0",
  "/app.js?v=6.8.0",
