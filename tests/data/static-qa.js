...
for (const asset of ['/js/engines/learning-engine.js?v=7.5.2','/js/engines/practical-engine.js?v=7.5.2','/js/engines/grading-engine.js?v=7.5.2','/js/engines/recall-engine.js?v=7.5.2','/js/engines/review-engine.js?v=7.5.2','/js/engines/history-engine.js?v=7.5.2','/js/engines/storage-engine.js?v=7.5.2','/data/questions/production.js?v=7.5.2','/js/practice/practice-engine.js?v=7.5.2','/js/practice/practice-ui.js?v=7.5.2','/js/app.js?v=7.5.2','/data/learning-aids/core-flow.js?v=7.5.2','/data/curriculum/2015/transition-reference.js?v=7.5.2','/data/curriculum/mappings/2015-2022.js?v=7.5.2']) if(!html.includes(asset)) throw new Error(`missing script ${asset}`);
...
for (const asset of ['/js/engines/learning-engine.js?v=7.5.2','/js/engines/practical-engine.js?v=7.5.2','/js/engines/grading-engine.js?v=7.5.2','/js/engines/recall-engine.js?v=7.5.2','/js/engines/review-engine.js?v=7.5.2','/js/engines/history-engine.js?v=7.5.2','/js/engines/storage-engine.js?v=7.5.2','/data/questions/production.js?v=7.5.2','/js/practice/practice-engine.js?v=7.5.2','/js/practice/practice-ui.js?v=7.5.2','/data/learning-aids/core-flow.js?v=7.5.2','/data/curriculum/2015/transition-reference.js?v=7.5.2','/data/curriculum/mappings/2015-2022.js?v=7.5.2']) if(!sw.includes(asset)) throw new Error(`SW missing ${asset}`);
