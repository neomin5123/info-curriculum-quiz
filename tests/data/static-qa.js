...
for (const asset of ['/js/engines/learning-engine.js?v=7.7.0','/js/engines/practical-engine.js?v=7.7.0','/js/engines/grading-engine.js?v=7.7.0','/js/engines/recall-engine.js?v=7.7.0','/js/engines/structure-engine.js?v=7.7.0','/js/engines/review-engine.js?v=7.7.0','/js/engines/history-engine.js?v=7.7.0','/js/engines/storage-engine.js?v=7.7.0','/js/engines/planner-engine.js?v=7.7.0','/data/questions/production.js?v=7.7.0','/js/practice/practice-engine.js?v=7.7.0','/js/practice/practice-ui.js?v=7.7.0','/js/app.js?v=7.7.0','/data/learning-aids/core-flow.js?v=7.7.0','/data/curriculum/2015/transition-reference.js?v=7.7.0','/data/curriculum/mappings/2015-2022.js?v=7.7.0']) if(!html.includes(asset)) throw new Error(`missing script ${asset}`);
...
for (const asset of ['/js/engines/learning-engine.js?v=7.7.0','/js/engines/practical-engine.js?v=7.7.0','/js/engines/grading-engine.js?v=7.7.0','/js/engines/recall-engine.js?v=7.7.0','/js/engines/structure-engine.js?v=7.7.0','/js/engines/review-engine.js?v=7.7.0','/js/engines/history-engine.js?v=7.7.0','/js/engines/storage-engine.js?v=7.7.0','/js/engines/planner-engine.js?v=7.7.0','/data/questions/production.js?v=7.7.0','/js/practice/practice-engine.js?v=7.7.0','/js/practice/practice-ui.js?v=7.7.0','/data/learning-aids/core-flow.js?v=7.7.0','/data/curriculum/2015/transition-reference.js?v=7.7.0','/data/curriculum/mappings/2015-2022.js?v=7.7.0']) if(!sw.includes(asset)) throw new Error(`SW missing ${asset}`);
