...
for (const asset of ['/js/learning-engine.js?v=6.11.1','/js/practical-engine.js?v=6.11.1','/js/grading-engine.js?v=6.11.1','/js/review-engine.js?v=6.11.1','/js/history-engine.js?v=6.11.1','/js/storage-engine.js?v=6.11.1','/data/practice-bank.js?v=6.11.1','/js/practice-engine.js?v=6.11.1','/js/practice-ui.js?v=6.11.1','/app.js?v=6.11.1']) if(!html.includes(asset)) throw new Error(`missing script ${asset}`);
...
for (const asset of ['/js/learning-engine.js?v=6.11.1','/js/practical-engine.js?v=6.11.1','/js/grading-engine.js?v=6.11.1','/js/review-engine.js?v=6.11.1','/js/history-engine.js?v=6.11.1','/js/storage-engine.js?v=6.11.1','/data/practice-bank.js?v=6.11.1','/js/practice-engine.js?v=6.11.1','/js/practice-ui.js?v=6.11.1']) if(!sw.includes(asset)) throw new Error(`SW missing ${asset}`);
