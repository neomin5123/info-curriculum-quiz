...
for(const marker of ['id="practiceTab"','id="practicePage"','id="practiceSubject"','id="practiceArea"','id="practiceVersion"','id="practiceQuestionArea"']) if(!html.includes(marker)) throw new Error(`practice UI missing ${marker}`);
...
console.log(`v6.10 practice regression QA: OK (${bank.questions.length} current production questions)`);
