...
for(const marker of ['curriloop-v6-11-1-20260920','/js/practice-ui.js?v=6.11.1','/app.js?v=6.11.1']) if(!sw.includes(marker)) throw new Error(`v611 SW missing ${marker}`);
