...
for (const asset of ['/js/engines/learning-engine.js?v=7.6.1','/js/engines/practical-engine.js?v=7.6.1','/js/engines/grading-engine.js?v=7.6.1','/js/engines/recall-engine.js?v=7.6.1','/js/engines/structure-engine.js?v=7.6.1','/js/engines/review-engine.js?v=7.6.1','/js/engines/history-engine.js?v=7.6.1','/js/engines/storage-engine.js?v=7.6.1','/js/engines/planner-engine.js?v=7.6.1','/data/questions/production.js?v=7.6.1','/js/practice/practice-engine.js?v=7.6.1','/js/practice/practice-ui.js?v=7.6.1','/js/app.js?v=7.6.1','/data/learning-aids/core-flow.js?v=7.6.1','/data/curriculum/2015/transition-reference.js?v=7.6.1','/data/curriculum/mappings/2015-2022.js?v=7.6.1']) if(!html.includes(asset)) throw new Error(`missing script ${asset}`);
...
for (const marker of ['curriloop-daily-review-plan-v2','remainingDailyReviewItems','ensureDailyReviewPlan','curriloop-grading-overrides-v1','curriloop-practical-exam-progress-v1','practicalSetSummary','nextReviewInfo','core-achievement','achievement-guidance','historySort','CORE_FLOW_MAP','핵심 흐름','SOURCE_GROUPS','CurriLoopPracticeBridge','PRACTICE_SOURCE_LINK_KEY','openSourceModalByIds','openCurrentUnitSourceModal','gradeHolisticRecallBlock','renderStructurePractice','recallSectionConceptKey','syncMiddleInfoPilotControls','updateRecallSectionMastery','recall-free-input','recall-mastery-badge','RecallEngine.isRecallMastered','retryDistance','renderTodayHome','startPlannedNewStudy','isLongTermReviewEligible','DAILY_STUDY_PLANNER_KEY']) if(!app.includes(marker)) throw new Error(`missing review plan marker ${marker}`);
const sw=fs.readFileSync(path.join(root,'service-worker.js'),'utf8');
for (const asset of ['/js/engines/learning-engine.js?v=7.6.1','/js/engines/practical-engine.js?v=7.6.1','/js/engines/grading-engine.js?v=7.6.1','/js/engines/recall-engine.js?v=7.6.1','/js/engines/structure-engine.js?v=7.6.1','/js/engines/review-engine.js?v=7.6.1','/js/engines/history-engine.js?v=7.6.1','/js/engines/storage-engine.js?v=7.6.1','/js/engines/planner-engine.js?v=7.6.1','/data/questions/production.js?v=7.6.1','/js/practice/practice-engine.js?v=7.6.1','/js/practice/practice-ui.js?v=7.6.1','/data/learning-aids/core-flow.js?v=7.6.1','/data/curriculum/2015/transition-reference.js?v=7.6.1','/data/curriculum/mappings/2015-2022.js?v=7.6.1']) if(!sw.includes(asset)) throw new Error(`SW missing ${asset}`);
