...
assert(html.includes('v8.0.0-rc'));assert(sw.includes('curriloop-v8-0-0-stage6-full-policy-20260927'));
assert(html.includes('/data/learning-aids/pilot-policy.js?v=8.0.0-rc'));assert(html.includes('/js/engines/pilot-policy-engine.js?v=8.0.0-rc'));assert(html.includes('/data/learning-aids/gap-intensity.js?v=8.0.0-rc'));assert(html.includes('/data/learning-aids/exam-recall-profiles.js?v=8.0.0-rc'));assert(html.includes('/js/engines/intensity-engine.js?v=8.0.0-rc'));
