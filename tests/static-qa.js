...
for (const asset of ['/js/learning-engine.js?v=6.14.0','/js/practical-engine.js?v=6.14.0','/js/grading-engine.js?v=6.14.0','/js/review-engine.js?v=6.14.0','/js/history-engine.js?v=6.14.0','/js/storage-engine.js?v=6.14.0','/data/practice-bank.js?v=6.14.0','/js/practice-engine.js?v=6.14.0','/js/practice-ui.js?v=6.14.0','/app.js?v=6.14.0']) if(!html.includes(asset)) throw new Error(`missing script ${asset}`);
...
for (const asset of ['/js/learning-engine.js?v=6.14.0','/js/practical-engine.js?v=6.14.0','/js/grading-engine.js?v=6.14.0','/js/review-engine.js?v=6.14.0','/js/history-engine.js?v=6.14.0','/js/storage-engine.js?v=6.14.0','/data/practice-bank.js?v=6.14.0','/js/practice-engine.js?v=6.14.0','/js/practice-ui.js?v=6.14.0']) if(!sw.includes(asset)) throw new Error(`SW missing ${asset}`);
