...
for (const asset of ['/js/engines/learning-engine.js?v=7.5.3','/js/engines/practical-engine.js?v=7.5.3','/js/engines/grading-engine.js?v=7.5.3','/js/engines/recall-engine.js?v=7.5.3','/js/engines/structure-engine.js?v=7.5.3','/js/engines/review-engine.js?v=7.5.3','/js/engines/history-engine.js?v=7.5.3','/js/engines/storage-engine.js?v=7.5.3','/data/questions/production.js?v=7.5.3','/js/practice/practice-engine.js?v=7.5.3','/js/practice/practice-ui.js?v=7.5.3','/js/app.js?v=7.5.3','/data/learning-aids/core-flow.js?v=7.5.3','/data/curriculum/2015/transition-reference.js?v=7.5.3','/data/curriculum/mappings/2015-2022.js?v=7.5.3']) if(!html.includes(asset)) throw new Error(`missing script ${asset}`);
...
for (const marker of ['id="structureButton"','구조 연습','id="reviewRecallArea"','id="difficultyField"']) if(!html.includes(marker)) throw new Error(`missing v7.5 UI marker ${marker}`);
...
for (const asset of ['/js/engines/learning-engine.js?v=7.5.3','/js/engines/practical-engine.js?v=7.5.3','/js/engines/grading-engine.js?v=7.5.3','/js/engines/recall-engine.js?v=7.5.3','/js/engines/structure-engine.js?v=7.5.3','/js/engines/review-engine.js?v=7.5.3','/js/engines/history-engine.js?v=7.5.3','/js/engines/storage-engine.js?v=7.5.3','/data/questions/production.js?v=7.5.3','/js/practice/practice-engine.js?v=7.5.3','/js/practice/practice-ui.js?v=7.5.3','/data/learning-aids/core-flow.js?v=7.5.3','/data/curriculum/2015/transition-reference.js?v=7.5.3','/data/curriculum/mappings/2015-2022.js?v=7.5.3']) if(!sw.includes(asset)) throw new Error(`SW missing ${asset}`);
