...
for (const asset of ['/js/engines/learning-engine.js?v=7.5.1','/js/engines/practical-engine.js?v=7.5.1','/js/engines/grading-engine.js?v=7.5.1','/js/engines/recall-engine.js?v=7.5.1','/js/engines/review-engine.js?v=7.5.1','/js/engines/history-engine.js?v=7.5.1','/js/engines/storage-engine.js?v=7.5.1','/data/questions/production.js?v=7.5.1','/js/practice/practice-engine.js?v=7.5.1','/js/practice/practice-ui.js?v=7.5.1','/js/app.js?v=7.5.1','/data/learning-aids/core-flow.js?v=7.5.1','/data/curriculum/2015/transition-reference.js?v=7.5.1','/data/curriculum/mappings/2015-2022.js?v=7.5.1']) if(!html.includes(asset)) throw new Error(`missing script ${asset}`);
...
for (const asset of ['/js/engines/learning-engine.js?v=7.5.1','/js/engines/practical-engine.js?v=7.5.1','/js/engines/grading-engine.js?v=7.5.1','/js/engines/recall-engine.js?v=7.5.1','/js/engines/review-engine.js?v=7.5.1','/js/engines/history-engine.js?v=7.5.1','/js/engines/storage-engine.js?v=7.5.1','/data/questions/production.js?v=7.5.1','/js/practice/practice-engine.js?v=7.5.1','/js/practice/practice-ui.js?v=7.5.1','/data/learning-aids/core-flow.js?v=7.5.1','/data/curriculum/2015/transition-reference.js?v=7.5.1','/data/curriculum/mappings/2015-2022.js?v=7.5.1']) if(!sw.includes(asset)) throw new Error(`SW missing ${asset}`);
